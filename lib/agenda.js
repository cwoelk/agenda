...
var Agenda = module.exports = function(config, cb) {
  ...
  this._dbAdapter = getDbAdapterClass(config, cb || handleCallback);
};
...
Agenda.prototype.mongo = function( mdb, collection, cb ) {
  this._dbAdapter.mongo(mdb, collection, handleCallback);
  return this
}

Agenda.prototype.pg = function( mdb, table, cb ) {
  this._dbAdapter.pg(mdb, table, handleCallback);
  return this
}

Agenda.prototype.db_init = function( collection, cb ) {
  this._dbAdapter.db_init(collection, handleCallback);
}
